...
<div class="container mt-4">
    ...
    <div class="bg-white rounded-lg shadow my-4 mx-2 p-4">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div class="flex flex-col md:flex-row items-center gap-3 w-full md:w-auto">
                ...
                <!-- Tombol Tambah -->
                <a href="/user/tambah" class="btn bg-green-900 text-white hover:bg-green-400 hover:text-black rounded-lg">
                    Tambah
                </a>
    ...
    @include('components.table', [
        'head' => 'Semua Akun',   {{-- JUDUL TABEL --}}
        'table' => 'users',      {{-- TABEL DATABASE --}}
        'sortBy' => 'id',         {{-- PENGURUTAN --}}
    ])
</div>
<div class="btn bg-green-900 text-white hover:bg-green-400 hover:text-black button-fixed-corner">
    <a href="/user/tambah"><i class="bi bi-plus"></i></a>
</div>
...
<script>
    ...
    document.querySelectorAll('.btn-table-delete').forEach(button => {
        button.addEventListener('click', function () {
            ...
            selectedDeleteUrl = `/user/${id}`; // atau gunakan route jika perlu
